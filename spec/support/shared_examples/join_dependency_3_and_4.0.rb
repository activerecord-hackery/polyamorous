shared_examples "Join Dependency on ActiveRecord 3 and 4.0" do
  context 'with symbol joins' do
    ...
    specify { expect(subject.join_associations).to be_all { |a| a.join_type == Arel::InnerJoin } }
  end
  ...
  context 'with outer join' do
    ...
    specify { expect(subject.join_associations.size).to eq(1) }
    specify { expect(subject.join_associations).to be_all { |a| a.join_type == Arel::OuterJoin } }
  end
